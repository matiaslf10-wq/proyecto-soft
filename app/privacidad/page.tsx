      ...
      <section className="mx-auto max-w-4xl px-5 py-16">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-zinc-700">
          ...
          <section>
            ...
            <p className="mt-2">
              RestoSmart puede recopilar información proporcionada a través del
              formulario de contacto, como nombre, email, teléfono y datos del negocio.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              coordinar demostraciones y brindar información sobre nuestros servicios.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              recibida y no compartimos datos con terceros sin consentimiento,
          ...
          <section>
            ...
            <p className="mt-2">
              Actualmente RestoSmart no utiliza cookies con fines publicitarios.
              En caso de incorporar herramientas de análisis en el futuro,
          ...
          <section>
            ...
            <p className="mt-2">
              Podés solicitar la modificación o eliminación de tus datos
