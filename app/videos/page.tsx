...
function VideoCard({
  ...
  const thumbSrc = videoId
    ? `https://images.weserv.nl/?url=i.ytimg.com/vi/${videoId}/hqdefault.jpg`
    : null;
      ...
      <div className="relative aspect-video bg-gray-200 rounded-lg overflow-hidden">
        {!isHovered ? (
          ...
          <iframe
            src={
              videoId
                ? `https://www.youtube.com/embed/${videoId}?autoplay=1&mute=1&controls=0&rel=0&loop=1&playlist=${videoId}`
                : undefined
            }
